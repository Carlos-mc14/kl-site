            ...
            <FormItem>
              ...
              <FormControl>
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent>
                    <SelectItem value="estrategia-digital">Estrategia Digital</SelectItem>
                    <SelectItem value="social-media">Social Media</SelectItem>
                    <SelectItem value="publicidad-digital">Publicidad Digital</SelectItem>
                    <SelectItem value="marketing-contenidos">Marketing de Contenidos</SelectItem>
                    <SelectItem value="produccion-audiovisual">Producción Audiovisual</SelectItem>
                    <SelectItem value="diseno-branding">Diseño y Branding</SelectItem>
                    <SelectItem value="analitica-reportes">Analítica y Reportes</SelectItem>
                    <SelectItem value="paquete-impulso">Paquete IMPULSO</SelectItem>
                    <SelectItem value="paquete-conexion">Paquete CONEXIÓN</SelectItem>
                    <SelectItem value="paquete-expansion">Paquete EXPANSIÓN</SelectItem>
                  </SelectContent>
                </Select>
              </FormControl>
              <FormMessage />
