    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Crea un nuevo servicio para mostrar en la página principal.</p>
        </div>
        <Card>
          <CardHeader>
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Completa la información del servicio que se mostrará en la página principal.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
